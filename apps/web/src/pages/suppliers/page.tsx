  ...
  return (
    ...
    >
      <div className="shrink-0">
        ...
        />
        {error && <p className="border-b border-border px-4 py-2 text-sm text-destructive">{error}</p>}
        {!companyId && (
          <p className="border-b border-border px-4 py-2 text-sm text-muted-foreground">Önce Giriş Yapmalısınız.</p>
        )}
      </div>
