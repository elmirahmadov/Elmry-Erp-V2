        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring disabled:bg-muted"
            >
          ...
          <div className="flex gap-2 pt-1">
            <button
              ...
              onClick={onClose}
              disabled={isLoading || loadingTills}
              className="flex-1 px-4 py-2 text-sm font-medium text-foreground bg-muted hover:bg-muted rounded-lg transition-colors disabled:opacity-50"
            >
              İptal
            </button>
            <button
              ...
              className="flex-1 px-4 py-2 text-sm font-medium text-success-foreground rounded-lg transition-colors disabled:opacity-50 bg-success hover:bg-success/90"
            >
